...
export const strings = {
  zh: {
    ...
    setSecGeneral: '通用',
    setMcp: '本地 MCP 服务',
    setMcpDesc: '让外部 AI 助手（如 Claude Desktop、Cursor）通过本应用生成 Word 文档。仅限本机访问。',
    setMcpPort: '端口',
    setSecAbout: '关于',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服务商',
  ...
  en: {
    ...
    setMcpDesc: 'Let external AI agents (Claude Desktop, Cursor…) create Word documents through this running app. Localhost only.',
    setMcpPort: 'Port',
    setSecAbout: 'About',
  ...
  ja: {
    ...
    setMcpDesc: '外部の AI エージェント（Claude Desktop、Cursor など）がこのアプリ経由で Word 文書を作成できるようにします。ローカルホストのみ。',
    setMcpPort: 'ポート',
    setSecAbout: '情報',
    setSecAiModel: 'AIモデル',
  ...
  ko: {
    ...
    setSecGeneral: '일반',
    setMcp: '로컬 MCP 서버',
    setMcpDesc: '외부 AI 에이전트(Claude Desktop, Cursor 등)가 이 앱을 통해 Word 문서를 만들 수 있게 합니다. 로컬호스트 전용.',
    setMcpPort: '포트',
    setSecAbout: '정보',
    setSecAiModel: 'AI 모델',
    setAiProvider: '제공업체',
  ...
  fr: {
    ...
    setMcpDesc: 'Permet à des agents IA externes (Claude Desktop, Cursor…) de créer des documents Word via cette application. Localhost uniquement.',
    setMcpPort: 'Port',
  ...
  de: {
    ...
    setMcpDesc: 'Erlaubt externen KI-Agenten (Claude Desktop, Cursor…), über diese laufende App Word-Dokumente zu erstellen. Nur localhost.',
    setMcpPort: 'Port',
    setSecAbout: 'Über',
  ...
  es: {
    ...
    setMcpDesc: 'Permite que agentes de IA externos (Claude Desktop, Cursor…) creen documentos de Word a través de esta aplicación. Solo localhost.',
    setMcpPort: 'Puerto',
  ...
  th: {
    ...
    setMcpDesc: 'ให้เอเจนต์ AI ภายนอก (Claude Desktop, Cursor…) สร้างเอกสาร Word ผ่านแอปที่เปิดอยู่ได้ จำกัดเฉพาะ localhost',
    setMcpPort: 'พอร์ต',
  ...
  id: {
    ...
    setMcpDesc: 'Izinkan agen AI eksternal (Claude Desktop, Cursor…) membuat dokumen Word melalui aplikasi ini. Hanya localhost.',
    setMcpPort: 'Port',
    setSecAbout: 'Tentang',
  ...
  ru: {
    ...
    setMcpDesc: 'Позволяет внешним ИИ-агентам (Claude Desktop, Cursor…) создавать документы Word через это приложение. Только localhost.',
    setMcpPort: 'Порт',
  ...
  ar: {
    ...
    setMcpDesc: 'يتيح لوكلاء الذكاء الاصطناعي الخارجيين (Claude Desktop وCursor…) إنشاء مستندات Word عبر هذا التطبيق. على المضيف المحلي فقط.',
    setMcpPort: 'المنفذ',
    setSecAbout: 'حول',
  ...
  pt: {
    ...
    setSecGeneral: 'Geral',
    setMcp: 'Servidor MCP local',
    setMcpDesc: 'Permite que agentes de IA externos (Claude Desktop, Cursor…) criem documentos do Word por meio deste aplicativo. Somente localhost.',
    setMcpPort: 'Porta',
    setSecAbout: 'Sobre',
    setSecAiModel: 'Modelo de IA',
  ...
  it: {
    ...
    setMcpDesc: 'Consente ad agenti IA esterni (Claude Desktop, Cursor…) di creare documenti Word tramite questa app. Solo localhost.',
    setMcpPort: 'Porta',
  ...
  pl: {
    ...
    setMcpDesc: 'Pozwala zewnętrznym agentom AI (Claude Desktop, Cursor…) tworzyć dokumenty Word przez tę aplikację. Tylko localhost.',
    setMcpPort: 'Port',
  ...
  cs: {
    ...
    setMcpDesc: 'Umožňuje externím AI agentům (Claude Desktop, Cursor…) vytvářet dokumenty Word prostřednictvím této aplikace. Pouze localhost.',
    setMcpPort: 'Port',
  ...
  nl: {
    ...
    setMcpDesc: 'Laat externe AI-agenten (Claude Desktop, Cursor…) Word-documenten maken via deze actieve app. Alleen localhost.',
    setMcpPort: 'Poort',
    setSecAbout: 'Over',
    setSecAiModel: 'AI-model',
    setAiProvider: 'Provider',
  ...
  ms: {
    ...
    setMcpDesc: 'Benarkan ejen AI luar (Claude Desktop, Cursor…) mencipta dokumen Word melalui aplikasi ini. Localhost sahaja.',
    setMcpPort: 'Port',
    setSecAbout: 'Perihal',
    setSecAiModel: 'Model AI',
    setAiProvider: 'Penyedia',
  ...
  he: {
    ...
    setMcpDesc: 'מאפשר לסוכני בינה מלאכותית חיצוניים (Claude Desktop, Cursor…) ליצור מסמכי Word דרך האפליקציה הפועלת. localhost בלבד.',
    setMcpPort: 'יציאה',
    setSecAbout: 'אודות',
  ...
  hi: {
    ...
    setMcpDesc: 'बाहरी AI एजेंट (Claude Desktop, Cursor…) को इस चल रहे ऐप के ज़रिए Word दस्तावेज़ बनाने दें। केवल localhost।',
    setMcpPort: 'पोर्ट',
    setSecAbout: 'जानकारी',
  ...
  'zh-TW': {
    ...
    setSecGeneral: '一般',
    setMcp: '本機 MCP 服務',
    setMcpDesc: '讓外部 AI 助理（如 Claude Desktop、Cursor）透過本應用程式產生 Word 文件。僅限本機存取。',
    setMcpPort: '連接埠',
    setSecAbout: '關於',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服務商',
