...
export const strings = {
  ...
  en: {
    ...
    setMcpCapPlanned: 'Sheets · Slides · PDF',
  ...
  ja: {
    ...
    setMcpCapPlanned: 'スプレッドシート · プレゼンテーション · PDF',
  ...
  ko: {
    ...
    setMcpCapPlanned: '스프레드시트 · 프레젠테이션 · PDF',
  ...
  fr: {
    ...
    setMcpCapPlanned: 'Feuilles de calcul · Présentations · PDF',
  ...
  de: {
    ...
    setMcpCapPlanned: 'Tabellen · Präsentationen · PDF',
  ...
  es: {
    ...
    setMcpCapPlanned: 'Hojas de cálculo · Presentaciones · PDF',
  ...
  th: {
    ...
    setMcpCapPlanned: 'สเปรดชีต · งานนำเสนอ · PDF',
  ...
  id: {
    ...
    setMcpCapPlanned: 'Spreadsheet · Presentasi · PDF',
  ...
  ru: {
    ...
    setMcpCapPlanned: 'Таблицы · Презентации · PDF',
    setMcpCapSoon: 'Скоро',
  ...
  ar: {
    ...
    setMcpCapPlanned: 'جداول بيانات · عروض تقديمية · PDF',
  ...
  pt: {
    ...
    setMcpCapPlanned: 'Planilhas · Apresentações · PDF',
  ...
  it: {
    ...
    setMcpCapPlanned: 'Fogli di calcolo · Presentazioni · PDF',
  ...
  pl: {
    ...
    setMcpCapPlanned: 'Arkusze · Prezentacje · PDF',
  ...
  nl: {
    ...
    setMcpCapPlanned: 'Spreadsheets · Presentaties · PDF',
  ...
  ms: {
    ...
    setMcpCapPlanned: 'Hamparan · Persembahan · PDF',
  ...
  he: {
    ...
    setMcpCapPlanned: 'גיליונות · מצגות · PDF',
    setMcpCapSoon: 'בקרוב',
    setMcpBg: 'יצירה ברקע',
    setMcpBgDesc:
  ...
  hi: {
    ...
    setMcpCapPlanned: 'स्प्रेडशीट · प्रस्तुतियाँ · PDF',
